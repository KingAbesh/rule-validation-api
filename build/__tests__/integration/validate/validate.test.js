...
const invalid_json_1 = __importDefault(require("../../data/invalid.json"));
const no_rule_field_json_1 = __importDefault(require("../../data/no-rule-field.json"));
const no_required_field_within_rule_object_json_1 = __importDefault(require("../../data/no-required-field-within-rule-object.json"));
const wrong_type_json_1 = __importDefault(require("../../data/wrong-type.json"));
const field_not_in_data_json_1 = __importDefault(require("../../data/field-not-in-data.json"));
const fails_validation_json_1 = __importDefault(require("../../data/fails-validation.json"));
const passes_validation_json_1 = __importDefault(require("../../data/passes-validation.json"));
